...
export class TrackingChartComponent implements AfterViewInit {
  ...
  initEventListeners() {
    ...
    jQuery(this.chartContainer.nativeElement).bind('plothover', (event, pos) => {
  ...
  ngAfterViewInit() {
    ...
    this.legend = jQuery(this.chartContainer.nativeElement).find('.legendLabel');
